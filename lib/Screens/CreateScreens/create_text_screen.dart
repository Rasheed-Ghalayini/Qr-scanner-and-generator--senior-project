...
class CreateTextScreen extends StatefulWidget {
  const CreateTextScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CreateTextScreenState createState() => _CreateTextScreenState();
}
...
class _CreateTextScreenState extends State<CreateTextScreen> {
  ...
  Widget icon = const Icon(Icons.text_format, color: Colors.white);
  String name = "Text QR Code";
  Mat.Color color = Colors.orange;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Create Text Barcode"),
      ),
      body: ListView(
        children: [
          Column(
            children: [
              ...
              Padding(
                ...
                child: TextField(
                  decoration:
                      const InputDecoration(labelText: 'Enter Text Here'),
                    ...
                    onPressed: () {
                      setState(() {
                        if(myController.text.isNotEmpty) {
                          generatedText = myController.text;
                          db.genBarcodes?.add(Barcodes(
                              content: generatedText, type: "TEXT"));
                          db.updateDatabase();
                        }
                        else{
      ...
      // bottomNavigationBar: AdmobService.GenerateBannerAd(_banner),
