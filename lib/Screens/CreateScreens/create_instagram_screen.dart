...
class CreateInstagramScreen extends StatefulWidget {
  const CreateInstagramScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CreateInstagramScreenState createState() => _CreateInstagramScreenState();
}
...
class _CreateInstagramScreenState extends State<CreateInstagramScreen> {
  ...
  Widget icon = const FaIcon(FontAwesomeIcons.instagram, color: Colors.white);
  String name = "Instagram";
  Mat.Color color = const Mat.Color(0xffdd2a7b);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Create Instagram Barcode"),
        ),
        body: ListView(
            children: [
        Column(
    ...
    generatedText = 'instagram://user?username=${myController.text}';
    db.genBarcodes?.add(Barcodes(
    content: generatedText, type: "INSTAGRAM"));
    db.updateDatabase();
    // }
    // else{
    //
