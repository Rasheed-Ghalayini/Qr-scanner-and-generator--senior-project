...
class _CreateEmailScreenState extends State<CreateEmailScreen> {
  ...
  Widget icon = const Icon(Icons.email, color: Colors.white);
  String name = "E-mail";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Create E-mail Barcode"),
        ),
        body: ListView(
            children: [
        Column(
    ...
    child: Form(
      ...
      child: TextFormField(
      decoration: const InputDecoration(labelText: 'Enter E-mail Address Here'),
    ...
    generatedText = 'mailto:${myController.text}';
    db.genBarcodes?.add(Barcodes(
    content: generatedText, type: "EMAIL"));
    db.updateDatabase();
    }
    else{
