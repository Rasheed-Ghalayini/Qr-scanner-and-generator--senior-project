...
class CreateFacebookScreen extends StatefulWidget {
  const CreateFacebookScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CreateFacebookScreenState createState() => _CreateFacebookScreenState();
}
...
class _CreateFacebookScreenState extends State<CreateFacebookScreen> {
  ...
  Widget icon = const FaIcon(FontAwesomeIcons.facebook,color: Colors.white,);
  String name = "Facebook";
  Mat.Color color = const Mat.Color(0xff3b5998);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Create Facebook QR Code"),
        ),
        body: ListView(
            children: [
        Column(
    ...
    child: Form(
      ...
      child: TextFormField(
      decoration: const InputDecoration(labelText: 'Enter Facebook Username'),
    ...
    generatedText = 'fb://profile/${myController.text}';
    db.genBarcodes?.add(Barcodes(
    content: generatedText, type: "FACEBOOK"));
    db.updateDatabase();
    // }
    // else{
    //
