...
class CreateWhatsappScreen extends StatefulWidget {
  const CreateWhatsappScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CreateWhatsappScreenState createState() => _CreateWhatsappScreenState();
}
...
class _CreateWhatsappScreenState extends State<CreateWhatsappScreen> {
  ...
  Widget icon = const FaIcon(FontAwesomeIcons.whatsapp, color: Colors.white);
  String name = "Whatsapp";
  Mat.Color color = Mat.Color(0xff128c7e);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Create Whatsapp Barcode"),
      ),
      body: ListView(
        children: [
          Column(
              ...
              Padding(
                ...
                child: Form(
                    ...
                    child: IntlPhoneField(
                      ...
                      onChanged: (phone) {
                        generatedText = phone.completeNumber;
                      },
                    )),
              ),
              Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      setState(() {
                        ...
                        generated = true;
                        generatedText = 'whatsapp://send?phone=${generatedText}';
                        db.genBarcodes?.add(
                            Barcodes(content: generatedText, type: "WHATSAPP"));
                        db.updateDatabase();
                        // }
                        // else{
                        //
