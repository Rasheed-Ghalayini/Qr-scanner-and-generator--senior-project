...
class CreateYoutubeScreen extends StatefulWidget {
  const CreateYoutubeScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CreateYoutubeScreenState createState() => _CreateYoutubeScreenState();
}
...
class _CreateYoutubeScreenState extends State<CreateYoutubeScreen> {
  ...
  Widget icon = const FaIcon(FontAwesomeIcons.youtube,color: Colors.white,);
  String name = "Youtube";
  Mat.Color color = const Mat.Color(0xffff0000);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Create Youtube QR Code"),
        ),
        body: ListView(
            children: [
        Column(
    ...
    child: Form(
      ...
      child: TextFormField(
      decoration: const InputDecoration(labelText: 'Enter Youtube Channel ID'),
    ...
    generatedText = 'https://www.youtube.com/channel/${myController.text}';
    db.genBarcodes?.add(Barcodes(
    content: generatedText, type: "YOUTUBE"));
    db.updateDatabase();
    // }
    // else{
    //
