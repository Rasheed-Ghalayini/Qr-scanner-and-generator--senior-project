...
_launchContactUrl(Scan result) async {
...
Future<File> _generateBarcode(Scan result, bool withText) async {
...
_shareContent(Scan result) async {
  File file = await _generateBarcode(result, true);
...
class _ScanResultState extends State<ScanResult> {
  ...
  void initState() {
    ...
    isUri = hasValidUrl(widget.result.content);
